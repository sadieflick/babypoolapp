...
const renderHomePage = () => {
        ...
        <div style="font-family: 'Poppins', sans-serif; padding: 2rem; text-align: center;">
            ...
            <div style="max-width: 600px; margin: 0 auto; background: white; padding: 2rem; border-radius: 10px; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
                ...
                <div style="display: flex; flex-direction: column; gap: 1rem; margin: 2rem 0;">
                    ...
                    <a id="guest-login-btn" style="text-decoration: none; background-color: #99ccff; color: #333; padding: 0.75rem 1.5rem; border-radius: 30px; font-weight: 500; box-shadow: 0 4px 8px rgba(153, 204, 255, 0.3); transition: all 0.3s ease; cursor: pointer;">Join as Guest</a>
    ...
    // Add direct click handler for guest login button
